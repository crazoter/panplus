OfflineMP2Audio = (function(){ "use strict";

// Copy of mp2.js by Dominic Szablewski with modifications that make it inappropriate to extend the class
...
MP2.prototype = Object.create(OfflineBaseDecoder.prototype);
...
MP2.prototype.decode = function() {
    ...
    if (this.destination) {
        ...
        this.destination.play(this.sampleRate, left, right, this.getCurrentTime());
    }
